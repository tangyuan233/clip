...
> **摘要**:
>  作者在谷歌工作约14年后，总结了21条工程职业经验。核心观点是：成功的工程师不一定是代码写得最好的，而是懂得处理代码之外事务的人。关键教训包括：专注解决用户问题而非迷恋技术；共识比正确更重要；倾向于行动而非追求完美；清晰优于巧妙；谨慎采用新技术；让工作成果可见；最好的代码是无需编写的代码；大规模系统中连bug也有用户依赖；团队缓慢通常是目标不一致而非执行力差；关注可控之事；理解抽象层之下的机制；写作与教学促进理解；有意识地处理“胶水工作”；警惕赢下每场争论；指标会被操纵；领导者敢于承认不确定；人脉比工作更长久；性能优化靠删除工作而非增加复杂度；流程应减少不确定性；明确时间与金钱的权衡；学习会复利。最终归结为保持好奇、谦逊，始终以人为本。
>  
>  **要点总结**:
>  1. 工程师成功的关键在于解决用户问题、促成团队共识和采取行动，而非仅靠技术能力。
>  2. 职业发展需注意：以清晰代码降低运维风险，仅在关键处创新，并让自身贡献在组织中被看见。
>  3. 技术与管理智慧：兼容性即产品，性能优化重在删减而非添加，流程应旨在降低不确定而非流于形式。
>  4. 人际与自我管理：建立长期人脉，有意识地投入“胶水工作”，承认不确定以营造学习氛围，并专注于可控因素。
>  5. 长期主义：明确工作与生活的权衡，通过持续实践与反思实现知识复利，在长期职业生涯中实现成长。
