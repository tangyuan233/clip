...
date: 2026-09-05 23:39:05
updated: 2026-09-05 23:39:05
taxonomies:
  tags: []
extra:
  ...
  author: antirez
  original_title: Control the ideas, not the code
  original_lang: en
---

> **摘要**:
> 作者（antirez）作为资深程序员，认为编程领域正被AI深刻改变，程序员应适应新角色：从逐行审查代码转向“控制思想”（即把握软件的核心设计理念）。他解释为何建议不再主要依赖阅读代码：AI能生成大量代码，审核不现实；AI擅长局部优化而人应关注整体设计；时间应花在思考软件方向、新想法和QA上。他以Redis为例，说明自己虽仍审查AI生成的代码，但认为此举更多是习惯和对用户的尊重，未来更有价值的是编写描述数据结构和设计思路的文档，以便人类和AI理解。他提倡将精力放在设计、测试和理念上，并指出软件行业在AI前已存在大量“劣质”问题，AI有助于解决。最后他建议年轻程序员学习编程基础（如实现小型解释器、数据库），而不是耗费时间审查低质量代码。
> 
> **要点总结**:
> 1. 程序员应重点“控制思想”而非阅读代码：AI已能产出大量代码，审查不现实且无效。
> 2. 应将时间用于思考软件方向、新想法、设计和QA，而非逐行审阅。
> 3. 已有作品（如Redis）的代码审查多为习惯，未来更需用文档描述设计供人与AI使用。
> 4. AI前软件行业已存在大量劣质代码，AI反而有助于提升质量。
> 5. 年轻程序员应学习编程基础（如写解释器、数据库），而非浪费在审查琐碎代码上。
> 6. 个别复杂领域（如AI推理）仍需严谨的工程与测试，AI可辅助但非万能。
> 
> **客观性检查**: 文章带有明显的个人观点和劝说意图，作者立场鲜明地倡导“不读代码”的新范式，并使用“完全腐烂”等情绪化、绝对化措辞（如“软件世界已经彻底腐烂”），同时以自身经历和成功案例增强说服力，但未充分讨论反对意见或风险，因此属于带有个人倾向的评论性文章。

---


[antirez](https://antirez.com/user/antirez) 54 days ago. 310171 views.
```
