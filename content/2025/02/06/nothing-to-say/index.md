...
> **摘要**: 作者逐渐意识到自己没什么可说的，这种认识伴随着自我舒适感的增强。相较于现代过度传播的信息，作者认为这种“无言”是一种解放，然而当今文化中接收的能力普遍下降，尤其在艺术领域。艺术本应给予观众接收的空间，但许多现代艺术作品却变得越来越自我中心，忽视观众的人性与参与感。社交媒体的结构抑制了深度接收，导致人们的注意力、同理心、以及真实沟通能力的减少。作者认为，Substack等平台因其设计促进了接收与参与，使得人与人之间的链接更加真实和有意义。通过这些平台，用户不仅是信息的接受者，更是积极的参与者，能够在这个过程中体验到有价值的交流和思考。
> 
>  **要点总结**:
>  1. 个人对无言的认知是一种解放，而非自卑。
>  2. 当今文化中的接收能力受到影响，艺术未能给予观众应有的空间。
>  3. 社交媒体削弱了人们的接收能力，导致多种社会问题的产生。
>  4. Substack等平台通过促进接收，提供了更有意义的交流空间。
>  5. 在数字世界中，沉默成为理解与参与的关键。
