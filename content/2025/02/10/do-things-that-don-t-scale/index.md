...
date: '2025-02-10T22:13:10+08:00'
updated: '2013-07-10T22:13:10+08:00'
taxonomies:
  tags: null
extra:
...
> **摘要**:
>  文章强调了创业初期的重要性，特别是需要采取不具规模化的措施来获得用户和促进成长。很多创始人误认为创业公司成功与否由市场决定，实际上，成功往往是创始人通过积极努力去实现的。通过人为招募用户、提供卓越的用户体验和关注细微之处，初创公司能够建立起基础。文章列举了Stripe、Airbnb等公司的成功案例，强调了在早期运营中手动介入和客户互动的重要性。此外，文章还警示了创业者不要期待一锤子解决全部问题的“大众推出”，而是要脚踏实地地积累用户和反馈。通过这些不具规模的方法，创业公司能在早期建立起良好的增长模式，并为未来的发展奠定基础。
> 
>  **要点总结**:
>  1. 创业初期需要采取不具规模的方法，例如手动招募用户和参与用户体验。
>  2. 许多成功创业公司通过积极的用户获取和反馈迭代实现成长，而不是等待用户自然涌入。
>  3. 关注初始用户的体验，提供超出预期的服务，能为企业建立忠诚度。
>  4. “大规模推出”往往并不利于创业初期的成功，积累早期用户更为重要。
>  5. 初创企业应当把核心理念视为产品及其推广方式的结合，以实现双重增长。

---


![Do Things that Don't Scale](do-things-that-don-t-scale-3.gif)
