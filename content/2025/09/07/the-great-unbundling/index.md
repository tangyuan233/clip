...
> **摘要**: 文章探讨了互联网对媒体行业的重大影响，强调了各类媒体在变革中所面临的不同挑战和机遇。传统媒体依赖于分发和整合的模型，分发需要大量前期投资，使得拥有分发渠道的公司能够通过整合内容和广告实现盈利。随着互联网降低了分发成本，尤其是文本出版物的垄断地位崩溃，广告商能够直接接触用户，传统的整合模式破裂。音乐行业相对较好地适应了这种变化，但电视行业仍在抵抗中。文章指出，电视通过报道、教育、直播体育、讲故事和提供娱乐来满足观众需求，其中的前两项已被互联网接管。然而，逃避现实的功能未来可能会被其他平台（如Facebook）取代。Netflix则在创造内容和故事讲述方面展现出了新的潜力，整个媒体行业正在经历“伟大的解捆绑”，内容与用户、广告商分离，传统的捆绑销售模式正在消失。
> 
>  **要点总结**:
>  1. 互联网降低了媒体的分发成本，冲击了传统媒体的盈利模式。
>  2. 传统纸媒依赖的广告整合模式因失去用户注意力而崩溃。
>  3. 音乐行业通过流媒体与音乐专辑的整合仍保持了较高的收益。
>  4. 电视行业面临着来自互联网平台分流用户和广告的压力。
>  5. 整个媒体行业正经历解捆绑，各类服务取代了传统捆绑模式。
