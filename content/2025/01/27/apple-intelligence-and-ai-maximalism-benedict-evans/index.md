...
> **摘要**: 文章探讨了苹果在生成性AI领域的战略及其对大语言模型（LLMs）的看法，认为后者应被视为商品基础设施，而非平台或产品。苹果的AI产品尚未全面推出，且只在iPhone 15 Pro等特定设备上实现。文章提出，苹果的基础模型偏向于将生成性AI视为嵌入系统中、提供用户上下文的技术，而非开放式聊天机器人。苹果在功能上将生成性AI与用户的上下文数据结合，保护用户隐私，同时考虑到运行成本。与OpenAI的关系也被分析，认为苹果可能将其视为可替代插件，而非独立解决方案。文章最后提出，目前对生成性AI的市场接受度仍不确定，未来产品形态与市场契合度仍需观察。
> 
>  **要点总结**:
>  1. 苹果将生成性AI视作商品基础设施，而非产品或平台，并将在用户上下文中嵌入使用。
>  2. 苹果的基础模型不依赖于聊天机器人，而是提供用户隐私保护的特定功能。
>  3. 苹果与OpenAI的关系是互补的，OpenAI作为可替代插件，承担部分风险和成本。
>  4. 对于生成性AI的市场接受度仍然未知，未来的产品市场契合度有待观察。
