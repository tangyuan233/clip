...
> **摘要**: 文章探讨了苹果在生成性AI方面的策略，认为生成AI应被视作一种基础设施而非产品，而目前苹果的AI功能尚未普及，且缺乏广泛使用。苹果的技术理念强调生成AI应嵌入用户系统中，提供上下文支持，并细化为更易处理的各类功能。这使得苹果能够在用户设备上高效运行AI模型，而代价较低，同时保护用户隐私。与OpenAI等公司相比，苹果尝试将AI产品化，但也面临品牌风险，将开放式的AI模型作为插件使用，从而确保用户的期望值合理。文章还指出，生成AI的未来仍充满不确定性，各大公司在此领域的布局各有不同，苹果提倡将AI作为功能整合于产品中，而非形成独立的通用工具。
> 
>  **要点总结**:
>  1. 苹果将生成AI视为基础设施，而非产品，强调其在用户系统中的作用。
>  2. 生成AI应该嵌入上下文，使得个性化功能更为高效，减少对计算资源的需求。
>  3. 苹果的AI模型设计旨在避免开放式问答带来的品牌风险，通过功能细分来提高用户体验。
>  4. 生成AI的市场和产品尚未稳定，各大公司有不同的发展策略。
>  5. 生成AI可能更加偏向于功能整合，而非普适工具，这将影响产品设计和市场格局。
