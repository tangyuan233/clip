...
> **摘要**: 本文探讨了苹果对生成式人工智能的看法，认为它不是一个产品，而是一种技术基础设施，类似于商品。苹果的智能功能尚未推出，并且在现有的iPhone中仅适用于少数型号。文章指出，生成式AI应当嵌入在既有系统中，并且应分解为易于在移动设备上运行的独立功能。苹果没有开发聊天机器人，而是将基础模型集成进各种功能中，如电子邮件优先级和文档摘要，用户通常看不到模型的直接输出。苹果的“上下文模型”能够利用用户的私人信息来优化个性化体验，而处理开放式问题则通过第三方“世界模型”来实现，这样能够减少品牌风险。作者还讨论了苹果与OpenAI之间的关系，认为苹果在基础模型构建方面具备优势，且在市场上并不存在单一获胜者的局面。最后，文章提出，未来生成式AI更可能成为众多公司产品中的标准功能，而非某一公司独占的通用工具。
> 
>  **要点总结**:
>  1. 苹果认为生成式AI是一种技术，而非单一产品，强调其商品化属性。
>  2. 苹果的智能功能需要在设备上运行，并细分为小型独立功能以确保高效。
>  3. 苹果构建了上下文模型以利用用户信息，提升个性化服务，同时将开放式查询委托给第三方。
>  4. 相较于OpenAI，苹果在用户上下文信息上具有优势，并可能实施更具防御性的策略。
>  5. 未来生成式AI的发展趋势可能是成为各公司产品中的标准功能，而非某一公司独占的解决方案。
