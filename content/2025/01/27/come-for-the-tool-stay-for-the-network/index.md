...
> **摘要**: 本文提出了一种网络启动策略，即“为工具而来，因网络而留”。该策略通过最初提供单用户工具来吸引用户，再通过发展网络来提高用户的长期价值和公司的竞争力。文章以两个历史实例解释这一策略：*Delicious*提供云书签服务作为单用户工具，并创建标签系统作为多用户网络；*Instagram*则靠创新的照片滤镜吸引用户，再发展其社交网络。虽然“为工具而来，因网络而留”并非唯一的建立网络方法，但对于从零开始建立网络而言，单用户工具的重要性不可小觑，犹如点燃火焰的引火物。
> 
>  **要点总结**:
>  1. “为工具而来，因网络而留”的策略通过单用户工具吸引用户，建立长期价值。
>  2. 历史实例*Delicious*和*Instagram*展示了此策略的成功应用。
>  3. 虽然有成功的网络无需单用户工具，但从零开始建立网络仍然很具挑战性。
>  4. 单用户工具可以视为创建网络的基础，帮助达到初始的临界质量。
>  5. 实证显示，网络的竞争力和用户价值来自于其多用户互动的特性。
