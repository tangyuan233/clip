...
> **摘要**:
>  本文是「商业内观」Newsletter 的第一期，主题为“混乱与秩序”。文章探讨了信息资源的分类，将其分为挖井人、维护者、普及者和投喂者四类，并指出信息爆炸时代下，一二手信息的高门槛导致信息壁垒加剧，信息技术并未消除不平等，反而可能加速这一过程。作者引用罗素和怀特海的观点，强调智慧的增长依赖于原则层面的认知同步，而非碎片化知识的积累。文章还讨论了底层认知的重要性，认为通过内观可以刷新投影源，进而改变对世界的理解。最后，作者引用龙虾教授的话，表达了对未来探索的期待。
> 
>  **要点总结**:
>  1. 信息资源分为四类：挖井人（一手信息）、维护者（二手信息）、普及者（三手信息）和投喂者（四手信息），信息爆炸时代下，一二手信息的高门槛加剧了信息不平等。
>  2. 信息技术并未消除信息壁垒，反而可能加速不平等，数据资源掌握在少数人和公司手中，普通人难以获取和使用。
>  3. 智慧的增长依赖于原则层面的认知同步，碎片化知识通过模式化学习被整合为智慧，底层认知是通往高维认知的关键。
>  4. 认知既是通往高维的阶梯，也是障碍，内观可以帮助刷新投影源，改变对世界的理解。
>  5. 作者引用龙虾教授的话，表达了对未来探索的期待，认为自愿踏上征途并坚持到底的人将获得更深的理解。
