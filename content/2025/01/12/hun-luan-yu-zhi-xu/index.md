...
> **摘要**: 本期《商业内观》探讨了信息资源的不同层级和在大数据时代的认知冲突，区分了挖井人、维护者、普及者和投喂者四类信息提供者，并指出信息壁垒可能因技术而加深，造成社会的不平等。作者引用尤瓦尔·赫拉利的观点，提出信息技术未能消除不平等，反而加速了这种过程。同时，强调了知识的碎片化以及如何通过底层认知体系将信息转化为智慧，呼吁内观以提升个体的认知层次。此外，提出了有关商业的混乱与内观的秩序，最终期待通过《商业内观》来探讨更深层的认知和洞见。
> 
>  **要点总结**:
>  1. 信息资源可分为挖井人、维护者、普及者和投喂者，各类信息的认知层级影响着个体对信息的理解与利用。
>  2. 大数据时代的信息壁垒加深，普通人获取和处理信息的能力受到限制，导致社会不平等现象加剧。
>  3. 知识的碎片化与底层认知结构的建立对信息转化为智慧至关重要。
>  4. 内观是提升认知层次的重要方式，旨在推动个体从低维度向高维度认知进阶。
>  5. 通过《商业内观》，旨在探讨商业中的混乱与秩序之间的关系，以提升认知与理解。
