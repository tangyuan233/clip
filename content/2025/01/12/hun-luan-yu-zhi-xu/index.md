...
**摘要**：
本文是《商业内观》Newsletter 的第一期，主题为“混乱与秩序”。作者探讨了信息资源的分类，从一手信息到四手信息，分析了信息爆炸时代的知识获取与认知提升的挑战。文章还引用了尤瓦尔·赫拉利的观点，指出信息技术并未消除不平等，反而加剧了信息壁垒。作者通过引用罗素、刘丰等人的观点，强调了底层认知的重要性，认为通过内观可以刷新认知，将信息转化为智慧。最后，作者讨论了知乎的商业化选择，指出其从高质量内容平台转向内容消费的变现方式，引发了用户的不满。

**要点总结**：
1. 信息资源的分类：一手信息（挖井人）、二手信息（维护者）、三手信息（普及者）、四手信息（投喂者），不同层次的信息需要不同的认知资源进行加工。
2. 信息技术加剧了信息不平等：数据掌握在少数人和公司手中，普通人难以获取和使用数据，信息技术并未消除信息壁垒，反而加速了不平等。
3. 底层认知的重要性：通过内观和模式学习，可以将碎片化的信息转化为智慧，刷新底层认知，提升对世界的理解。
4. 知乎的商业化选择：知乎从高质量内容平台转向内容消费的变现方式，引发了用户对其初心的质疑，选择了“容易的路”而非“正确的路”。
5. 错位竞争模型：在生鲜电商领域，通过需求端、供给端和连接端的错位竞争，企业可以在激烈的市场竞争中找到差异化优势。
