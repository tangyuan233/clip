...
> **摘要**:
> 本文是《商业内观》第一期，主题为“混乱与秩序”，探讨了信息资源到知识结构的演化过程。作者将信息资源分为四类：挖井人（一手信息）、维护者（二手信息）、普及者（三手信息）和投喂者（四手信息），并指出信息爆炸时代，数据掌握在少数人手中，信息技术并未消除不平等，反而加剧了信息壁垒。文章还讨论了底层认知的重要性，认为通过内观可以刷新底层认知，将数据转化为智慧。最后，作者引用龙虾教授的话，强调自愿踏上征途的重要性，并展望了未来《商业内观》的发展方向。

> **要点总结**:
> 1. 信息资源分为四类：挖井人（一手信息）、维护者（二手信息）、普及者（三手信息）和投喂者（四手信息），信息爆炸时代数据掌握在少数人手中。
> 2. 信息技术并未消除不平等，反而加剧了信息壁垒，普通人难以获取和使用数据。
> 3. 底层认知是通往高维的阶梯，通过内观可以刷新底层认知，将信息转化为智慧。
> 4. 认知既是阶梯也是障碍，需要不断颠覆现有认知结构，才能看清世界的真相。
> 5. 作者引用龙虾教授的话，强调自愿踏上征途的重要性，并展望了未来《商业内观》的发展方向。
