...
> **摘要**:  
>  文章作者回顾了自己十多年的编程生涯，分享了从持续学习、独立思考到与优秀同事共事等多方面的感悟。作者强调编程不仅仅是技术问题，更涉及职场、生活和自我提升。通过不断学习新语言和框架，作者认为编程的核心竞争力在于解决问题的能力，而非特定语言或工具。此外，作者还提到英语学习的重要性、独立思考的必要性，以及身体健康对职业生涯的长期影响。最后，作者总结道，编程是一个不断积累和提升的过程，未来的目标是在技术之外，继续探索更多可能性。
> 
>  **要点总结**:
>  1. **持续学习**：编程领域变化迅速，作者通过不断学习新语言和框架，保持竞争力，认为语言只是工具，核心在于解决问题的能力。
>  2. **学好英语**：英语是获取前沿技术和融入全球开发者社区的关键，作者通过坚持学习英语，成功从国内跳槽到加拿大工作。
>  3. **独立思考**：作者强调独立思考的重要性，认为在技术选型和决策中，不应盲目跟随潮流，而应根据实际情况做出判断。
>  4. **与优秀的人共事**：作者认为与优秀的同事共事不仅能提升技术能力，还能建立高质量的人脉网络，对职业发展至关重要。
>  5. **身体是革命的本钱**：作者提醒程序员要注意身体健康，避免职业病，保持良好的身体状态才能应对高强度的工作。
...
而蚂蚁金服内部使用的也并不是Spring/SpringMVC, 而是自主研发出发的 [Sofa框架](https://github.com/sofastack/sofa-rpc) [^7], Spring 社区后来觉得Spring框架过于重量级，不利于快速开发，又开发了更轻量级的 [SpringBoot](https://spring.io/projects/spring-boot) [^8], 而蚂蚁内部又推出了Sofa版本的 [Sofaboot](https://github.com/sofastack/sofa-boot) [^9]
