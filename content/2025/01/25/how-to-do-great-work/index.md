...
date: '2025-01-25T22:39:54+08:00'
updated: '2023-07-25T22:39:54+08:00'
taxonomies:
  tags: []
extra:
...
> **摘要**:
>  作者通过跨领域提炼，总结出一套适用于任何领域、面向雄心勃勃者的“做出伟大工作”的方法论。他认为核心流程是：选择有天赋且深感兴趣的工作，学习到知识前沿，发现并探索其中的空白。他强调“好奇心”是驱动这一切的引擎，能指引选择、推动探索。为保持动力，工作必须令人兴奋，并建议采用“顺风而行”的策略，不做过细规划，而是持续选择有趣且留有最佳选项的工作。作者还讨论了保持士气和身心健康的重要性，并反驳了“规划至上”与“复制可耻”等观点，认为初始模仿是学习的一部分，真正的原创在于新思想。最后，他鼓励读者有意识地问自己是否想做出伟大工作，并勇敢尝试，因为发现正等待着那些敢于行动的人。
>  
>  **要点总结**:
>  1. 做出伟大工作的四步法：找到兼具天赋与浓厚兴趣的领域、学习至前沿、发现知识缺口、并大胆探索这些有希望的缺口。
>  2. 好奇心是核心驱动力：它不仅是选择工作方向的指南针，也是驱动人克服困难、持续深入探索的引擎。
>  3. 采取“顺风而行”策略：与其制定死板的长期计划，不如在每个阶段选择最有趣、且能为未来保留最佳选项的工作，让项目自然演化。
>  4. 工作技巧与心态：需要保护整块工作时间、通过“欺骗性”的小任务启动工作、坚持完成项目、并保持智力上的诚实与不拘小节（“书呆子气”的优势）。
>  5. 勇气与自我激励：有意识地下定决心追求伟大工作，不因畏惧或谦逊而退缩，并依靠小但忠实的受众和支持性的同事来维持士气。
...
\[[17](https://paulgraham.com/#f17n)\] Be professionally curious about a few topics and idly curious about many more.
