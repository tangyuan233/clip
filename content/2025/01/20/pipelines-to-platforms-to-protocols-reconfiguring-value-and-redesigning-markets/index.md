...
> **摘要**:
>  文章探讨了价值创造模式的演变，强调了从传统的管道模式向平台模式转变的趋势，接着指出随着协议的出现，特别是无许可区块链协议的出现，价值创造正在再次发生根本性转变。作者认为，管道模式通过集中生产和消费实现价值创造，而平台模式则通过分散生产和个性化消费推动市场效率，降低搜索和议价成本，增加市场参与者的选择。但随着协议的应用，市场参与者的激励机制、财产权和消费者身份都发生了改变，消费者不再被平台锁定，生产者也能够通过代币等方式重新获得生产回报。最后，作者预测，管道、平台和协议将在不同的经济领域共存，各自发挥作用。
> 
>  **要点总结**:
>  1. 价值创造经历了从管道模式到平台模式的转变，现正向协议模式发展。
>  2. 管道模式强调集中生产和消费，而平台模式则促进了分散生产和个性化消费。
>  3. 协议通过去中心化激励机制改善生产者的回报，并解放消费者的身份。
>  4. 代币和协议的结合为市场提供新的经济激励和治理机制。
>  5. 管道、平台和协议将共存于经济体系中，各自适应不同的市场需求。
