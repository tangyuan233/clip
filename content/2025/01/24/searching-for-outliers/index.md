...
> **摘要**:
>  文章探讨了“重尾分布”在生活中的普遍性及其对决策的影响。作者通过自身写博客、创业、招聘等经历，阐述了重尾分布的特点：少数极端成功案例占据了大部分成果，而大多数尝试则效果平平。文章指出，面对重尾分布时，增加样本量、优化筛选策略、避免过早放弃是提高成功概率的关键。作者还强调了在重尾分布中，筛选标准应与实际目标高度相关，避免因无关因素错失潜在的成功机会。
> 
>  **要点总结**:
>  1. 重尾分布的特点是少数极端成功案例占据大部分成果，大多数尝试效果平平。
>  2. 增加样本量是提高成功概率的关键，尤其是在重尾分布中，更多的尝试意味着更高的机会找到极端成功的案例。
>  3. 筛选标准应与实际目标高度相关，避免因无关因素错失潜在的成功机会。
>  4. 在重尾分布中，优化筛选策略比优化单个样本更为重要，应优先考虑“可能卓越”而非“可能不错”的候选者。
>  5. 面对重尾分布时，保持耐心和信任过程至关重要，避免因多次失败而放弃有效的策略。
