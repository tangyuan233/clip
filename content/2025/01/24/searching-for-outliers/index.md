...
> **摘要**:
>  文章探讨了博客写作中的成果分布特点，论述了重尾分布这一概念，即少数成功案例往往远超常规结果，表现出极具影响力的效应。作者通过自己过去150篇博客的经验，指出尽管大部分文章未能引起关注，但几篇成功的文章却显著增加了订阅者，进而激励作者持续创作。重尾分布常见于工作、知识和人际关系等领域，因其潜在回报的极大差异，使人们在面对样本采集时容易产生误判。文中强调，从重尾分布中获得良好成果的关键在于多次采样，通过大量尝试和快速评估，提高找到“可能出色”的对象的概率。此外，作者建议在评估样本时，应关注潜在的“惊人”特质而不是单纯的“良好”特征，以防止错过真正的机会。
> 
>  **要点总结**:
>  1. 博客成果分布呈重尾特征，即成功案例显著超过常规成果。
>  2. 增加采样数量能显著提高发现高质量结果的概率。
>  3. 在评估候选人或机会时，应关注高潜力的特征。
>  4. 遇到失败时需耐心，坚持尝试，避免因个别失利沮丧。
>  5. 过滤过程要专注于“可能惊人”的特征，以更好识别出色候选。
