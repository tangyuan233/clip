...
> **摘要**: 作者分享了他在写博客中的经历，指出大多数博客的成果呈现重尾分布特点，即少数帖子能够引起广泛关注并获得高反馈，而大部分帖子则不被记住。这种现象在许多领域中都普遍存在，例如职业成功、知识工作、想法的影响力以及人际关系等。作者强调，了解和应对重尾分布对于提升成果至关重要，这意味着在选择样本时要多尝试，不要轻易放弃。作者提供了样本挑选的策略，包括寻找潜在的极端优秀候选者、快速评估候选人及其可能性，并重视反馈机制，避免因个别失败而气馁，从而提高最终成功的可能性。总体而言，作者鼓励在面对不确定性和反复失败时保持信心，以追求出色的成果。
> 
>  **要点总结**:
>  1. 博客文章的结果呈现重尾分布，少数文章成功引起关注，而大部分文章却不被记住。
>  2. 重尾分布在就业、知识工作、创意和人际关系等多个领域普遍存在。
>  3. 增加样本数量有助于发现潜在的优秀候选人，改进成功的可能性。
>  4. 有效的评估策略需关注于“潜在的卓越”而非“可能不错”的候选人。
>  5. 保持乐观和执着，重视反馈和快速迭代可以提升成果。
