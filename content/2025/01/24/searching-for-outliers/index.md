...
> **摘要**: 文章通过作者的博客写作经验，探讨了成果的“重尾”分布特征，即少数成功作品的影响远超过大多数平庸或失败的作品。作者总结了在创作或求职等多种情况下如何通过多样化尝试和合理评估筛选优质样本，以获取更出色的结果。文章强调在进行选样时，了解重尾分布的特性，有助于避免过早放弃或低估成功的可能。对于重尾分布，重要的是不断地积累样本，并具备正确的评估标准，从而提高寻找优秀结果的概率。
> 
>  **要点总结**:
>  1. 重尾分布意味着少数极端成功的结果远超一般结果，体现在博客写作和其他生活决策中。
>  2. 获取大量样本可以显著提高成功的可能性，因此在诸如求职、恋爱时应积极尝试更多可能性。
>  3. 需了解如何评估样本，制定与目标相关的有效筛选标准，不要只关注“看起来好”的候选者。
>  4. 在过程中要保持耐心，尽管常常会经历失败，但整体策略的重要性不容忽视。
