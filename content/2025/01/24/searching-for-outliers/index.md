...
> **摘要**: 文章探讨了“重尾分布”的概念，强调在某些情况下，成功的结果是由极少数的出色案例驱动的。通过作者的个人经验来阐述，通过不断的尝试和获取样本，可以有效提高成功的机会。作者指出，许多重要领域（如工作、创意、关系等）都呈现重尾特征，通常只有少数几个结果会带来显著的回报。对重尾分布的理解需要关注样本的数量和质量，合理评估候选的标准，并建立快速迭代的过程。作者提供了一系列策略，以提高从重尾分布中找到优质结果的可能性，包括增加样本量、了解潜在的优秀结果是什么样的、采取高关联性的评估标准等，同时提醒人们在面对多次失败时保持积极心态。
> 
>  **要点总结**:
>  1. 重尾分布意味着少数成功案例带来大部分结果，适用于工作、创意和人际关系等多个领域。
>  2. 不断增加样本量可以大幅提高找到优质结果的机会。
>  3. 必须明确优秀结果的标准，不应仅只关注一般的优质候选。
>  4. 快速筛选和评估候选的过程能够提高发现出色候选的效率。
>  5. 在面对频繁的失败时，保持积极心态至关重要，以避免对整体过程产生消极影响。
