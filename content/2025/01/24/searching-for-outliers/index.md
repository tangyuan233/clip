...
> **摘要**:  
>  作者通过自己写博客的经历，探讨了“重尾分布”在生活中的普遍性及其影响。重尾分布指的是少数极端事件（如爆款博客文章）占据了大部分的影响力，而大多数事件则相对平庸。作者指出，许多重要领域（如工作、创业、恋爱等）都遵循这种分布，因此理解并有效应对重尾分布至关重要。文章强调了在重尾分布中，增加样本量、优化筛选策略以及保持耐心的重要性，并提供了如何在这些领域中找到“异常值”的实用建议。
> 
>  **要点总结**:
>  1. 重尾分布的特点是少数极端事件占据了大部分影响力，作者通过博客写作的案例说明了这一点。
>  2. 许多重要领域（如工作、创业、恋爱等）都遵循重尾分布，因此理解这种分布对决策至关重要。
>  3. 在重尾分布中，增加样本量是提高找到“异常值”概率的关键策略。
>  4. 优化筛选策略，避免因无关因素排除潜在“异常值”，是应对重尾分布的有效方法。
>  5. 保持耐心并信任过程，避免因短期失败而放弃长期策略，是成功应对重尾分布的重要心态。
