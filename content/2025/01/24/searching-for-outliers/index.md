...
> **摘要**:
>  本文探讨了博客写作中成果的重尾分布特性，揭示了少数成功帖子占据大部分成效的现象。作者分享个人经验，指出大约95%的帖子很平凡，仅有少数引起关注。这种分布意味着成功很难预测，且在大多数情况下，出色成果的可能性高于一般结果。作者强调了解重尾分布的重要性，以避免在结果评估和样本抽样中的常见失误，如低估优异结果的可能性或未能抽样足够多的样本。重尾分布存在于生活中的多个领域，包括收入、成功的想法和人际关系，了解这种规律有助于做出更明智的选择。为获得更好的结果，作者建议多抽样、明确评估标准，并保持信心，即使多次失败也应视为获取质量样本的必要过程。
> 
>  **要点总结**:
>  1. 博客写作的成果通常呈现重尾分布，即少数优秀作品带来大部分影响。
>  2. 理解重尾分布帮助避免在选择和评估样本时的常见错误，如抽样不够和低估优异结果。
>  3. 重尾现象在生活多方面显现，包括收入、想法影响力、合作关系等。
>  4. 抽样次数越多，获得优秀结果的几率越高，持续失败是最终成功的必经之路。
>  5. 设定明确的评估标准，着重寻找“可能惊艳”的样本，而非“还不错”的样本。
