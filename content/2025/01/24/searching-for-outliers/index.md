...
> **摘要**: 本文探讨了重尾分布（heavy-tailed distribution）在博客写作和其他领域中的表现，指出在许多情况下，成功往往来自于少数几个突出表现的样本，而绝大多数样本则可能是平平无奇的。作者分享了自己在写作过程中的经验，强调通过不断地输出样本来提高成功的可能性。在招聘、建立人际关系或进行投资等领域，了解何时抽样以及如何评估样本的质量至关重要。通过大量抽样，可以增加找到优秀个体或项目的机会。此外，作者还提到在评估过程中，应更关注“可能极好的”候选者，而非“可能不错”的候选者，以避免错失潜在的出色选择。总体来说，意识到和利用重尾分布特点可以帮助优化决策过程，获得更好的结果。
> 
>  **要点总结**:
>  1. 重尾分布中，少数样本产生大部分成功，理解这种特性有助于更好地进行写作、招聘等活动。
>  2. 多进行抽样能够提高找到优秀结果的概率，必须在各类决策中加以运用。
>  3. 应关注“可能极好的”候选者，优化选择策略，以确保不轻易排除潜在的优秀个体。
>  4. 在评估过程中快速迭代采样策略，有助于识别优质样本。
>  5. 对于重大选择，应树立丰富的心态，理解更好的选择是可能存在的。
