...
> **摘要**: 文章探讨了写作博客的经验和重视“重尾分布”的概念，即在某些情况下，少数成功的结果往往远远超过其他典型结果。作者分享了自己在博客写作中遇到的成功与失败，并指出大部分博客文章都是平淡无奇的。通过理解重尾分布的特点，作者认为我们可以更好地避免在这一过程中出现的常见错误，如未能充分采样和低估潜在结果的质量。此外，作者举例说明了重尾分布在职业选择、知识工作者、情感关系和创业成功等多个领域的普遍存在及重要性，并提出在面对重尾分布时，增加采样的数量、明确潜在结果的质量，以及优化筛选过程是提升结果的重要策略。
> 
>  **要点总结**:
>  1. 博客写作的结果呈现重尾分布，少数文章成功而多数文章平凡。
>  2. 重尾分布在生活中的多个领域普遍存在，影响职业、情感和创业等结果。
>  3. 遇到重尾分布时，重要的是增加采样数量以提高发现突破的概率。
>  4. 理解评估标准，优化筛选过程以便识别真正的潜在“优秀”候选者。
>  5. 在面对失败或低质量样本时要保持积极心态，信任过程。
