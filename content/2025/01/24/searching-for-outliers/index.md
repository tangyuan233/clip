...
> **摘要**:  
>  作者通过自己写博客的经历，探讨了“重尾分布”在生活中的普遍性及其影响。重尾分布指的是少数极端事件（如热门博客文章、高收入工作等）对整体结果产生巨大影响的现象。作者指出，许多重要领域（如职业选择、创业、人际关系等）都遵循这种分布。为了在这种分布下获得成功，作者建议采取多尝试、优化筛选策略、快速迭代等方法，并提醒人们不要因多次失败而气馁，因为重尾分布的成功往往依赖于少数关键事件。
> 
>  **要点总结**:
>  1. 重尾分布是指少数极端事件对整体结果产生巨大影响的现象，常见于博客文章、职业选择、创业等领域。
>  2. 在重尾分布下，多尝试（如多写博客、多面试候选人）是提高成功概率的关键。
>  3. 筛选策略应注重寻找“可能卓越”的候选者，而非“大概率不错”的候选者，避免因过度筛选而错过潜在的成功机会。
>  4. 快速迭代和评估候选者有助于优化筛选过程，尤其是在反馈机制明确的情况下（如博客文章的阅读量）。
>  5. 面对多次失败时，应保持耐心并信任过程，因为重尾分布的成功往往依赖于少数关键事件。
