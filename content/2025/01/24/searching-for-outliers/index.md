...
> **摘要**:
>  文章讨论了博主在写作过程中的重大发现，即博客文章结果呈现出重尾分布特征，即极少数作品会获得显著成功，而绝大多数作品则不被记住。作者通过自己的写作经验，强调了在重尾分布中，获取大量样本能够显著提高成功概率，且常常需要对候选选项的评估进行调整，以识别潜在的优秀个体。文章还探讨了重尾分布在各个生活领域的重要性，如就业、恋爱、创业等，指出成功往往依赖于极少数的出色表现。作者提供了多种策略以优化筛选过程，包括大量尝试、明确寻求的标准以及快速迭代候选评估等，旨在帮助读者在抽样时获得最佳结果。
> 
>  **要点总结**:
>  1. 博客文章结果的重尾分布特点，极少数作品能获得广泛认可。
>  2. 大量尝试与样本获取可以提高识别优秀候选者的可能性。
>  3. 评估标准的优化对筛选过程至关重要，应关注“可能卓越”的候选者。
>  4. 成功往往依赖于极少数的出色表现，影响诸如职业、伴侣选择等。
>  5. 快速迭代评估与收益最大化为优化筛选策略的关键。
