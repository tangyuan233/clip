...
> **摘要**:
>  本文探讨了人工智能（AI）的爆发如何影响数据及数据业务，提出了两个主要观点：首先，信息和计算相对价值发生重大变化，导致软件和数据业务模式的转型；其次，全球数据和计算能力的绝对数量极大增加，影响信任、身份、质量及策展等领域。此外，文章回顾了数据和数据循环在过去十年商业模式成功中的重要性，指出数据爆炸是新商业模式的基础，并强调了数据与软件之间的互补关系。随着GPT等新技术的出现，人为数据的经济将迎来革命，产生新的商业生态和数据货币化机会，同时带来对数据质量的新关注，以应对海量信息带来的挑战。
> 
>  **要点总结**:
>  1. 人工智能的兴起造成信息和计算的相对价值重大改变，影响软件及数据业务模式。
>  2. 数据和计算的绝对数量大幅增加，影响信任、身份、质量与策展。
>  3. 数据爆炸是推动过去十年商业模式成功的关键因素，软件与数据相辅相成。
>  4. GPT等新技术促进数据经济的转型，带来数据货币化的新机会与挑战。
>  5. 面对海量信息，数据质量的重要性凸显，需建立信任机制以维护信息健康。
