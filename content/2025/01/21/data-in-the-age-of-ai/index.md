...
> **摘要**:
>  本文探讨了人工智能（AI）的爆发如何影响数据及数据业务。作者提出了两个主要观点：一是信息和计算的相对价值发生了重大变化，影响了软件和数据业务模式；二是全球数据和计算能力的绝对数量显著增加，影响了信任、身份、质量和数据管理。文章回顾了过去十年数据爆炸的历程，指出数据循环是推动最佳商业模式和AI革命的关键。随着计算成本的下降，数据存储变得廉价且充足，推动了广告、电商、物流等行业的快速发展。GPT等生成式AI的出现进一步提升了数据的价值，并催生了新的数据生态系统。未来，随着计算能力的爆炸式增长，数据将变得更加重要，而信任链和策展将成为应对信息泛滥的关键。
> 
>  **要点总结**:
>  1. **数据与计算的相对价值变化**：信息和计算的相对价值发生了重大变化，影响了软件和数据业务模式。
>  2. **数据与计算的绝对数量增加**：全球数据和计算能力的绝对数量显著增加，影响了信任、身份、质量和数据管理。
>  3. **数据爆炸推动商业模式**：过去十年的数据爆炸推动了广告、电商、物流等行业的快速发展，数据循环成为关键驱动力。
>  4. **生成式AI提升数据价值**：GPT等生成式AI的出现进一步提升了数据的价值，并催生了新的数据生态系统。
>  5. **信任链与策展的重要性**：随着计算能力的爆炸式增长，信任链和策展将成为应对信息泛滥的关键。
