...
> **摘要**: 本文探讨人工智能（AI）的突然崛起如何影响数据及数据业务，提出两个主要观点：第一，信息与计算的相对价值发生显著变化，改变了软件与数据的商业模式；第二，数据与计算的绝对数量显著增加，影响信任、身份和质量。作者回顾了数据循环如何驱动过去十年的商业模式，以及数据爆炸如何伴随软件开发的兴起，而GPT的出现进一步提升了计算的价值，从而改变了数据的相对价值。文章指出，拥有独特数据资产的企业将能够更有效地货币化这些资产，而那些潜在数据资产也逐渐受到重视。此外，在AI主导的世界中，传统的数据与计算生态系统需要重新设计，以适应新形势下的数据收集和使用需求。
> 
>  **要点总结**:
>  1. 数据与计算的价值相对变化，促进软件和数据商业模式调整。
>  2. 数据与计算的绝对数量显著增长，影响信任和信息质量。
>  3. GPT的出现提升了计算的效率，也改变了数据的货币化方式。
>  4. 企业需重新设计数据策略，以适应AI时代的新机遇与挑战。
>  5. 高质量数据和独特数据资产在AI时代愈发重要。
