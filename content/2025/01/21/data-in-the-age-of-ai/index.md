...
> **摘要**:
>  本文探讨了人工智能（AI）爆发对数据及数据业务的影响，提出两大重要观点：首先，信息和计算的相对价值发生了重大变化，这影响了软件及数据业务模式；其次，全球数据和计算能力的绝对数量显著增加，影响了信任、身份和数据质量。本质上，过去十年的数据爆炸推动了各大商业模式的发展，而如今，AI时代的计算爆炸将使数据价值提升。文章还指出，企业需要适应这一变化，以便于更好地利用数据资产，此外，信任链、数据质量和商业生态系统的重构在新环境下变得愈发重要。
> 
>  **要点总结**:
>  1. AI的崛起导致信息和计算的相对价值改变，促进了商业模式的转变。
>  2. 数据爆炸推动了新的商业模式，数据和计算的绝对数量变化显著。
>  3. 高质量数据资产在AI世界中将获得更高的关注和货币化机会。
>  4. 信任链的建立将在数据质量和身份验证中发挥关键作用。
>  5. 整个数据生态系统需要重新设计，以满足AI时代的需求。
