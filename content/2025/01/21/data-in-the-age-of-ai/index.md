...
> **摘要**:
>  本文讨论了人工智能的爆炸性增长如何影响数据及数据业务，提出了两个关键观点：一是信息和计算的相对价值发生重大变化，影响软件和数据商业模式；二是世界上可用的数据和计算的绝对数量显著增加，影响信任、身份、质量和策展等方面。文章回顾了过去几十年数据增长的历程，强调了数据和软件的相互依存关系以及如何推动商业模式的演变。随着GPT等技术的发展，计算的价值超过了以前的数据爆炸，使得数据变得更加重要，并带来了新的商业机会和挑战。文章还分析了信任链的概念，以及如何在数据和计算的世界中确保信息的质量与透明性，最终指出人类如何在低成本、高效率的AI时代中找到自身价值。
> 
>  **要点总结**:
>  1. 人工智能的崛起使数据的绝对和相对价值均发生变化。
>  2. 数据和计算的爆炸性增长加速了商业模式变革。
>  3. 数据的价值在AI时代大幅提升，前景充满商机。
>  4. 需要建立信任链以维护数据和信息的质量。
>  5. 人类在AI普及的背景下面临新的挑战与机遇。
